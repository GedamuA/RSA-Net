...
def get_parser():
    # parameter priority: command line > config_pre > default
    parser = argparse.ArgumentParser( description='Part-independent Attention  Network')
    parser.add_argument('--work-dir', default='./work_dir/temp', help='the work folder for storing results')

    parser.add_argument('-model_saved_name', default='')
    parser.add_argument( '--config', default='./config/nturgbd120-cross-set/Joint.yaml', help='path to the configuration file')
    ...
    parser.add_argument('-lr_decay_rate', type=float, default=0.1 , help='learing rate decay rate')
...
class Processor():
    ...
    def save_arg(self):
        ...
        with open('{}/config_pre.yaml'.format(self.arg.work_dir), 'w') as f:
